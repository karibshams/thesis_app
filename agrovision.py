...
def generate_pdf_report(image_pil, annotated_img, detections, image_quality, health_score, stats_df, section="full"):
    try:
        ...
        mt.setStyle(TableStyle([
            ...
            ('BACKGROUND',(0,1),(0,-1),rl_colors.HexColor('#1a5c2e')),
            ('BACKGROUND',(2,1),(2,-1),rl_colors.HexColor('#1a5c2e')),
            ('FONTNAME',(0,1),(0,-1),'Helvetica-Bold'),
            ('FONTNAME',(2,1),(2,-1),'Helvetica-Bold'),
            ('ALIGN',(0,0),(-1,-1),'CENTER'),
            ('FONTSIZE',(0,0),(-1,-1),9),
            ('GRID',(0,0),(-1,-1),0.5,rl_colors.HexColor('#aaddbb')),
            ('ROWBACKGROUNDS',(0,1),(-1,-1),[rl_colors.white,rl_colors.HexColor('#1a5c2e')]),
